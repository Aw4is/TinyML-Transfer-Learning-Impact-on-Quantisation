# PTQ (FX Graph Mode) eval for 5 FP32 checkpoints (seeds) 
# Quantises the entire mode to obtain INT8 accuracy and degradation 
# Purpose -> Check overall performance & degradation patterns of TL Regimes after quantisation (Section 4.2 results)
# Reference: https://pytorch.org/blog/quantization-in-practice/
