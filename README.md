...
First, point the quantisation script to the trained checkpoints (in Quantisation/Global), which should contain the five seed checkpoints generated during training:
